...
# If it is not a snapshot release, We also need to build images tagged with the 'release version'
if [[ $RELEASE_TYPE == "release" ]]
then
    echo "Not a Snapshot Release. Building Images With '${RELEASE_VERSION}' Tag."
