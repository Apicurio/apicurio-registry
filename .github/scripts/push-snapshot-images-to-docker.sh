...
case $BRANCH_NAME in
   ...
   "1.2.x" | "1.3.x")
      ...
      docker push apicurio/apicurio-registry-asyncmem:${BRANCH_NAME}-snapshot
      docker push apicurio/apicurio-registry-infinispan:${BRANCH_NAME}-snapshot
      docker push apicurio/apicurio-registry-jpa:${BRANCH_NAME}-snapshot
      docker push apicurio/apicurio-registry-kafka:${BRANCH_NAME}-snapshot
