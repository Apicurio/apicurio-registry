...
public class AuthConfig {
    ...
    @ConfigProperty(name = "apicurio.authn.proxy-header.strict", defaultValue = "false")
    @Info(category = CATEGORY_AUTH, description = "Require proxy headers when proxy authentication is enabled", availableSince = "3.1.7")
    ...
    @ConfigProperty(name = "apicurio.authn.public-paths")
    @Info(category = CATEGORY_AUTH, description = "Comma-separated list of URL path patterns that should be accessible without authentication (e.g., /health/*,/metrics/*)", availableSince = "3.1.0", registryAvailableSince = "3.1.0.Final", studioAvailableSince = "1.0.0")
    Optional<String> publicPaths;
