...
public interface ExporterResource {
    ...
    @POST
    String createExporter(ExporterDto exporter);

    @GET
    @Path("/{exporter}")
    String getExporter(@PathParam("exporter") String exporterName);

    @PUT
    @Path("/{exporter}")
    String updateExporter(@PathParam("exporter") String exporterName, ExporterDto exporter);

    @DELETE
    @Path("/{exporter}")
    String deleteExporter(@PathParam("exporter") String exporterName);

    @PUT
    @Path("/{exporter}/pause")
    String pauseExporter(@PathParam("exporter") String exporterName);

    @PUT
    @Path("/{exporter}/reset")
    String resetExporter(@PathParam("exporter") String exporterName);

    @PUT
    @Path("/{exporter}/resume")
    String resumeExporter(@PathParam("exporter") String exporterName);
    ...
    ExporterStatus getExporterStatus(@PathParam("exporter") String exporterName);

    @GET
    @Path("/{exporter}/config")
    Map<String, String> getExporterConfig(@PathParam("exporter") String exporterName);
}
