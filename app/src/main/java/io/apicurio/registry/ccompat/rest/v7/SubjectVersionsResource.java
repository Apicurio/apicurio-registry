...
public interface SubjectVersionsResource {
     ...
     * @param request – The schema string
     *
     * Status Codes:
     *
     ...
     *  @param version (versionId) – Version of the schema to be deleted. Valid values for versionId are between [1,2^31-1] or the string “latest”. “latest” deletes the last registered schema under the specified subject. Note that there may be a new latest schema that gets registered right after this request is served.
     *  @param permanent (boolean) -  Add ?permanent=true at the end of this request to specify a hard delete for a specific version of the subject, which removes all associated metadata including the schema ID. The default is false.
     *
     *
     * Response JSON Object:
     *
