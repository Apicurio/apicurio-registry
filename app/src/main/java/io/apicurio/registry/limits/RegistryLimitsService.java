...
public class RegistryLimitsService {
    ...
    public LimitsCheckResult canCreateArtifactVersion(String groupId, String artifactId,
            EditableArtifactMetaDataDto meta, ContentHandle content) {
    ...
    public LimitsCheckResult checkMetaData(EditableArtifactMetaDataDto meta) {
        ...
        if (meta.getName() != null
                && isLimitEnabled(RegistryLimitsConfiguration::getMaxArtifactNameLengthChars)) {
        ...
        if (meta.getDescription() != null
            ...
            if (meta.getDescription().length() > registryLimitsConfiguration
        ...
        if (meta.getLabels() != null) {
            if (isLimitEnabled(RegistryLimitsConfiguration::getMaxArtifactLabelsCount)
                ...
                meta.getLabels().forEach(l -> {
                    ...
                    if (l.getBytes(StandardCharsets.UTF_8).length > registryLimitsConfiguration
        ...
        if (meta.getProperties() != null) {
            if (isLimitEnabled(RegistryLimitsConfiguration::getMaxArtifactPropertiesCount) && meta
                    .getProperties().size() > registryLimitsConfiguration.getMaxArtifactPropertiesCount()) {
