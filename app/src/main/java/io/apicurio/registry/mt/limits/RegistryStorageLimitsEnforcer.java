 ...
 */
@ApplicationScoped
// TODO Use RegistryStorageDecoratorReadOnlyBase?
...
public class RegistryStorageLimitsEnforcer extends RegistryStorageDecoratorBase implements RegistryStorageDecorator {
    ...
    public LimitedActionExecutor withLimitsCheck(LimitsChecker checker) {
        return new LimitedActionExecutor() {
            ...
            @Override
            public <T> T execute(LimitedAction<T> action) throws ReadOnlyStorageException {
    ...
    @FunctionalInterface
    private interface LimitedAction<T> extends FunctionEx<T, ReadOnlyStorageException> {
    }
    ...
    private interface LimitedActionExecutor {
        ...
        <T> T execute(LimitedAction<T> action) throws ReadOnlyStorageException;
    }
}
