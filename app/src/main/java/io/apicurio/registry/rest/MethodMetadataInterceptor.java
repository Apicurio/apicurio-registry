 ...
 * {@link #EXTRACTED_PARAMETERS_KEY} as a {@code Map<String, String>}.
 */
@MethodMetadata
@Interceptor
...
public class MethodMetadataInterceptor {
     ...
     * Subsequent interceptors can retrieve the Map&lt;String, String&gt; from the invocation context.
     */
                ...
                try {
                    ...
                    if (positionInt < parameters.length) {
                        ...
                        if (parameterValue != null) {
                            extractedParams.put(metadataName, parameterValue.toString());
                        }
                    }
