...
public class RulesServiceImpl implements RulesService {
    ...
    /**
     * @see io.apicurio.registry.rules.RulesService#applyRules(java.lang.String, java.lang.String,
     *      java.lang.String, io.apicurio.registry.content.ContentHandle,
     *      io.apicurio.registry.rules.RuleApplicationType, java.util.List, java.util.Map)
     */
    @Override
    public void applyRules(String groupId, String artifactId, String artifactType,
            ContentHandle artifactContent, RuleApplicationType ruleApplicationType,
        ...
        applyGlobalAndArtifactRules(groupId, artifactId, artifactType, currentContent, artifactContent, rules,
    ...
    private void applyGlobalAndArtifactRules(String groupId, String artifactId, String artifactType,
        ...
        for (RuleType ruleType : globalOrArtifactRulesMap.keySet()) {
            applyRule(groupId, artifactId, artifactType, currentArtifactContent, updatedArtifactContent,
                    ruleType, globalOrArtifactRulesMap.get(ruleType).getConfiguration(), references,
                    resolvedReferences);
        }
    }

    /**
     * @see io.apicurio.registry.rules.RulesService#applyRule(java.lang.String, java.lang.String,
     *      java.lang.String, io.apicurio.registry.content.ContentHandle, io.apicurio.registry.types.RuleType,
     *      java.lang.String, io.apicurio.registry.rules.RuleApplicationType, java.util.List, java.util.Map)
     */
    @Override
    public void applyRule(String groupId, String artifactId, String artifactType,
            ContentHandle artifactContent, RuleType ruleType, String ruleConfiguration,
        ...
        applyRule(groupId, artifactId, artifactType, currentContent, artifactContent, ruleType,
    ...
    private void applyRule(String groupId, String artifactId, String artifactType,
            List<ContentHandle> currentContent, ContentHandle updatedContent, RuleType ruleType,
            String ruleConfiguration, List<ArtifactReference> references,
            Map<String, ContentHandle> resolvedReferences) {
        RuleExecutor executor = factory.createExecutor(ruleType);
        RuleContext context = new RuleContext(groupId, artifactId, artifactType, ruleConfiguration,
                currentContent, updatedContent, references, resolvedReferences);
        executor.execute(context);
    }

    /**
     * @see io.apicurio.registry.rules.RulesService#applyRules(java.lang.String, java.lang.String,
     *      java.lang.String, java.lang.String, io.apicurio.registry.content.ContentHandle, java.util.List,
     *      java.util.Map)
     */
    @Override
    public void applyRules(String groupId, String artifactId, String artifactVersion, String artifactType,
        ...
        applyGlobalAndArtifactRules(groupId, artifactId, artifactType,
                Collections.singletonList(versionContent.getContent()), updatedContent,
    ...
    public void applyRulesCompat(String groupId, String artifactId, String artifactVersion,
            String artifactType, ContentHandle updatedContent, List<ArtifactReference> references,
            Map<String, ContentHandle> resolvedReferences) throws RuleViolationException {
        ...
        applyGlobalAndArtifactRules(groupId, artifactId, artifactType,
                Collections.singletonList(
                        contentCanonicalizer.canonicalize(versionContent.getContent(), Map.of())),
                updatedContent, storage.getArtifactRules(groupId, artifactId), references,
                resolvedReferences);
    }
}
