...
public enum DiffType {
    ...
    OBJECT_TYPE_REQUIRED_PROPERTIES_CHANGED(false),
    ...
    OBJECT_TYPE_MIN_PROPERTIES_INCREASED(true),
    OBJECT_TYPE_MIN_PROPERTIES_DECREASED(false),
    ...
    OBJECT_TYPE_ADDITIONAL_PROPERTIES_BOOLEAN_ADDED(false),
    OBJECT_TYPE_ADDITIONAL_PROPERTIES_BOOLEAN_REMOVED(false),
    OBJECT_TYPE_ADDITIONAL_PROPERTIES_BOOLEAN_CHANGED(false),

    OBJECT_TYPE_ADDITIONAL_PROPERTIES_SCHEMA_ADDED(false),
    OBJECT_TYPE_ADDITIONAL_PROPERTIES_SCHEMA_REMOVED(true),

    OBJECT_TYPE_PROPERTY_DEPENDENCIES_ADDED(false),
    OBJECT_TYPE_PROPERTY_DEPENDENCIES_REMOVED(true),
    OBJECT_TYPE_PROPERTY_DEPENDENCIES_CHANGED(false),
    OBJECT_TYPE_PROPERTY_DEPENDENCIES_MEMBER_ADDED(false),
    OBJECT_TYPE_PROPERTY_DEPENDENCIES_MEMBER_REMOVED(true),

    OBJECT_TYPE_PROPERTY_DEPENDENCY_ADDED(false),
    OBJECT_TYPE_PROPERTY_DEPENDENCY_REMOVED(true),

    OBJECT_TYPE_SCHEMA_DEPENDENCIES_ADDED(false),
    OBJECT_TYPE_SCHEMA_DEPENDENCIES_REMOVED(true),
    OBJECT_TYPE_SCHEMA_DEPENDENCIES_CHANGED(false),
    ...
    OBJECT_TYPE_PATTERN_PROPERTY_ADDED(false),
    OBJECT_TYPE_PATTERN_PROPERTY_REMOVED(true),
    OBJECT_TYPE_PATTERN_PROPERTY_CHANGED(false),
    OBJECT_TYPE_PATTERN_PROPERTY_MEMBER_ADDED(false),
    OBJECT_TYPE_PATTERN_PROPERTY_MEMBER_REMOVED(true),
    ...
    ARRAY_TYPE_UNIQUE_ITEMS_ADDED(false),
    ARRAY_TYPE_UNIQUE_ITEMS_REMOVED(true),
    ARRAY_TYPE_UNIQUE_ITEMS_CHANGED(false), // TODO refactor booleans to consider specific transition

    ARRAY_TYPE_ADDITIONAL_ITEMS_ADDED(false),
    ARRAY_TYPE_ADDITIONAL_ITEMS_REMOVED(true),
    ARRAY_TYPE_ADDITIONAL_ITEMS_CHANGED(false), // TODO same here
    ...
    ARRAY_TYPE_CONTAINED_ITEMS_SCHEMA_ADDED(false),
    ARRAY_TYPE_CONTAINED_ITEMS_SCHEMA_REMOVED(true),

    ARRAY_TYPE_ITEMS_SCHEMAS_LENGTH_INCREASED(false),
    ARRAY_TYPE_ITEMS_SCHEMAS_LENGTH_DECREASED(false),

    ARRAY_TYPE_ITEMS_SCHEMA_ADDED(false),
    ARRAY_TYPE_ITEMS_SCHEMA_REMOVED(false), // TODO where
    ...
    ENUM_TYPE_VALUE_ADDED(true),
    ENUM_TYPE_VALUE_REMOVED(false),
    ...
    NUMBER_TYPE_IS_MINIMUM_EXCLUSIVE_CHANGED(false), // TODO boolean, same
    ...
    NUMBER_TYPE_IS_MAXIMUM_EXCLUSIVE_CHANGED(false),
    ...
    NUMBER_TYPE_MULTIPLE_OF_INCREASED(false),
    NUMBER_TYPE_MULTIPLE_OF_DECREASED(false),
    ...
    COMBINED_TYPE_ALL_OF_SIZE_DECREASED(false),
    ...
    NOT_TYPE_SCHEMA_NOT_FORWARD_COMPATIBLE(false),
    NOT_TYPE_SCHEMA_NOT_BACKWARD_COMPATIBLE(false),
