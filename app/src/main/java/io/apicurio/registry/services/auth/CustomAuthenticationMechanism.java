    ...
    public Uni<SecurityIdentity> customAuthentication(RoutingContext context, IdentityProviderManager identityProviderManager) {
        if (clientSecret.isEmpty()) {
            ...
            if (credentialsFromContext != null) {
                String jwtToken = new OidcAuth(httpClient, clientId, clientSecret.get()).obtainAccessTokenPaswordGrant(credentialsFromContext.getLeft(), credentialsFromContext.getRight());
                if (jwtToken != null) {
