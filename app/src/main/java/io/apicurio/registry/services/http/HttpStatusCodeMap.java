...
public class HttpStatusCodeMap {
    ...
    void init() {
        ...
        map.put(InvalidPeerException.class, HTTP_BAD_REQUEST);
        ...
        map.put(PeerAlreadyExistsException.class, HTTP_CONFLICT);
        map.put(PeerNotFoundException.class, HTTP_NOT_FOUND);
