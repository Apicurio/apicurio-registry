...
public interface RegistryStorage extends DynamicConfigStorage {
     ...
     * within the given artifact group. Returns a map of meta-data generated by the artifactStore layer, such
     * as the generated, globally unique globalId of the new value. If the group did not exist previously it
    ...
    /**
     * Creates a new artifact (from the given value including metadata) in the artifactStore. The artifactId
     * must be unique within the given artifact group. Returns a map of meta-data generated by the
     * artifactStore layer, such as the generated, globally unique globalId of the new value.
     *
     * @param groupId (optional)
     * @param artifactId
     * @param version (optional)
     ...
     * @throws RegistryStorageException
     */
    StoredArtifactDto getArtifact(String groupId, String artifactId)
            throws ArtifactNotFoundException, RegistryStorageException;

    /**
     * Gets the most recent version of the value of the artifact with the given group and ID.
     */
    StoredArtifactDto getArtifact(String groupId, String artifactId, ArtifactRetrievalBehavior behavior)
            throws ArtifactNotFoundException, RegistryStorageException;
     ...
     * @throws RegistryStorageException
     */
    ContentWrapperDto getArtifactByContentId(long contentId)
     ...
     * @throws RegistryStorageException
     */
    ContentWrapperDto getArtifactByContentHash(String contentHash)
            throws ContentNotFoundException, RegistryStorageException;
     ...
     * is NOT overwitten. Returns a map of meta-data generated by the artifactStore layer, such as the
     ...
     * Previous value is NOT overwitten. Returns a map of meta-data generated by the artifactStore layer, such
     * as the generated, globally unique globalId of the new value.
     *
     * @param groupId (optional)
     * @param artifactId
     * @param version (optional)
    ...
    /**
     * Gets the stored meta-data for an artifact by group and ID. This will include client-editable meta-data
     * such as name and description, but also generated meta-data such as "modifedOn" and "globalId".
     *
     * @param groupId (optional)
     * @param artifactId
     * @throws ArtifactNotFoundException
     ...
     * @throws RegistryStorageException
     */
    ArtifactVersionMetaDataDto getArtifactVersionMetaData(String groupId, String artifactId,
            boolean canonical, ContentHandle content, List<ArtifactReferenceDto> artifactReferences)
            throws ArtifactNotFoundException, RegistryStorageException;

    /**
     * Gets the stored meta-data for an artifact by global ID. This will include client-editable meta-data
     * such as name and description, but also generated meta-data such as "modifedOn" and "globalId".
     *
     * @param globalId
     * @throws ArtifactNotFoundException
     * @throws RegistryStorageException
     */
    ArtifactMetaDataDto getArtifactMetaData(long globalId)
            throws ArtifactNotFoundException, RegistryStorageException;

    /**
     * Updates the stored meta-data for an artifact by group and ID. Only the client-editable meta-data can be
     * updated. Client editable meta-data includes e.g. name and description. TODO what if set to null?
     *
     * @param groupId (optional)
     * @param artifactId
     * @param metaData
     ...
     * @throws RegistryStorageException
     */
    void updateArtifactOwner(String groupId, String artifactId, ArtifactOwnerDto owner)
            throws ArtifactNotFoundException, RegistryStorageException;
     ...
     * @throws RegistryStorageException
     */
    StoredArtifactDto getArtifactVersion(long globalId)
            throws ArtifactNotFoundException, RegistryStorageException;
     ...
     * @throws RegistryStorageException
     */
    StoredArtifactDto getArtifactVersion(String groupId, String artifactId, String version)
            throws ArtifactNotFoundException, VersionNotFoundException, RegistryStorageException;
    ...
    CommentDto createArtifactVersionCommentRaw(String groupId, String artifactId, String version,
