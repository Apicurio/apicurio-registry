...
public interface RegistryStorage {
    ...
    /**
     * Creates a new artifact (from the given content) in the storage.  The artifactId must be globally unique
     * within the storage layer.  Returns a map of meta-data generated by the storage layer, such as the 
     * generated, globally unique versionId of the new content.
     * @param artifactId
     * @param artifactType
     * @param content
    ...
    /**
     * Updates the artifact content by storing the given content as a new version of the artifact.  Previous content
     * is NOT overwitten.  Returns a map of meta-data generated by the storage layer, such as the generated,
     * globally unique versionId of the new content.
     * @param artifactId
     * @param artifactType
     * @param content
     * @throws ArtifactNotFoundException
