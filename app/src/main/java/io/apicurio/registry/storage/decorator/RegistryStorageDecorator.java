...
public abstract class RegistryStorageDecorator implements RegistryStorage {
     ...
     */
    @Override
    public ContentAndReferencesDto getArtifactByContentId(long contentId)
     ...
     */
    @Override
    public ContentAndReferencesDto getArtifactByContentHash(String contentHash)
            throws ContentNotFoundException, RegistryStorageException {
    ...
    /**
     * @see io.apicurio.registry.storage.RegistryStorage#getGlobalIdsReferencingArtifactVersion(String, String, String)
     */
    @Override
