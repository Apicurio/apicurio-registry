...
public class RegistryStorageDecoratorBase extends RegistryStorageDecoratorReadOnlyBase {
    ...
    public CommentDto createArtifactVersionCommentRaw(String groupId, String artifactId, String version,
        ...
        return delegate.createArtifactVersionCommentRaw(groupId, artifactId, version, commentId, createdBy,
                createdOn, value);
    }
    ...
    public ArtifactMetaDataDto updateArtifactWithMetadata(String groupId, String artifactId, String version,
        ...
        return delegate.updateArtifactWithMetadata(groupId, artifactId, version, artifactType, contentHash,
    ...
    public ArtifactMetaDataDto createArtifactWithMetadata(String groupId, String artifactId, String version,
            ...
            EditableArtifactMetaDataDto metaData, IdGenerator globalIdGenerator)
            throws ArtifactNotFoundException, RegistryStorageException {
        return delegate.createArtifactWithMetadata(groupId, artifactId, version, artifactType, contentHash,
                createdBy, createdOn, metaData, globalIdGenerator);
    }
