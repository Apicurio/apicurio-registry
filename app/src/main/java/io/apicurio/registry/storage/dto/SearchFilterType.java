...
public enum SearchFilterType {
    ...
    groupId, groupIdIn, groupIdInOrArtifactExact, artifactId, version, name, description, labels, contentHash, canonicalHash, globalId, contentId, state, artifactType, content, structure
