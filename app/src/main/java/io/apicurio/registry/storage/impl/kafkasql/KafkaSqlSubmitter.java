...
public class KafkaSqlSubmitter {
    ...
    public CompletableFuture<UUID> send(MessageKey key, MessageValue value) {
        ...
        ProducerRecord<MessageKey, MessageValue> record = new ProducerRecord<>(configuration.topic(), 0, key,
                value, Collections.singletonList(header));
     ...
     * ******************************************************************************************
     */
    public CompletableFuture<UUID> submitContent(long contentId, String contentHash, ActionType action,
            String canonicalHash, ContentHandle content, String serializedReferences) {
     ...
     * ******************************************************************************************
     */
    public CompletableFuture<UUID> submitArtifact(String groupId, String artifactId, String version,
            ActionType action, Long globalId, String artifactType, String contentHash, String createdBy,
            Date createdOn, EditableArtifactMetaDataDto metaData, Integer versionId, ArtifactState state,
            Long contentId, Boolean latest) {
        ArtifactKey key = ArtifactKey.create(groupId, artifactId);
        ArtifactValue value = ArtifactValue.create(action, globalId, version, artifactType, contentHash,
                createdBy, createdOn, metaData, versionId, state, contentId, latest);
        return send(key, value);
    }
    ...
    public CompletableFuture<UUID> submitArtifact(String groupId, String artifactId, String version,
        ...
        return submitArtifact(groupId, artifactId, version, action, globalId, artifactType, contentHash,
                createdBy, createdOn, metaData, null, null, null, null);
    }
     ...
     * ******************************************************************************************
     */
    public CompletableFuture<UUID> submitArtifactVersion(String groupId, String artifactId, String version,
            ActionType action, ArtifactState state, EditableArtifactMetaDataDto metaData) {
    ...
    public CompletableFuture<UUID> submitVersion(String groupId, String artifactId, String version,
            ActionType action) {
     ...
     * Owner ******************************************************************************************
     */
    public CompletableFuture<UUID> submitArtifactOwner(String groupId, String artifactId, ActionType action,
            String owner) {
     ...
     * Rule ******************************************************************************************
     */
    public CompletableFuture<UUID> submitArtifactRule(String groupId, String artifactId, RuleType rule,
            ActionType action, RuleConfigurationDto config) {
    ...
    public CompletableFuture<UUID> submitComment(String groupId, String artifactId, String version,
            String commentId, ActionType action, long globalId, String createdBy, Date createdOn,
            String value) {
    ...
    public CompletableFuture<UUID> submitComment(String groupId, String artifactId, String version,
        ...
        return submitComment(groupId, artifactId, version, commentId, action, -1, createdBy, createdOn,
                value);
    }
    ...
    public CompletableFuture<UUID> submitComment(String commentId, ActionType action, long globalId,
        ...
        return submitComment("<import-comments>", "_", "_", commentId, action, globalId, createdBy, createdOn,
                value);
    }
     ...
     * Mappings ******************************************************************************************
     */
    public CompletableFuture<UUID> submitRoleMapping(String principalId, ActionType action, String role,
