...
@ToString
public class CreateArtifactVersion6Message extends AbstractMessage {
    ...
    public Object dispatchTo(RegistryStorage storage) {
        ...
        return storage.createArtifactVersion(groupId, artifactId, version, artifactType, handle, references);
    }
