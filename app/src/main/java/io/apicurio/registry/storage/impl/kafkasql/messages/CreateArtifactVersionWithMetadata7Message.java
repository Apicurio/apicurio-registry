...
@ToString
public class CreateArtifactVersionWithMetadata7Message extends AbstractMessage {
    ...
    public Object dispatchTo(RegistryStorage storage) {
        ...
        return storage.createArtifactVersionWithMetadata(groupId, artifactId, version, artifactType, handle, metaData, references);
    }
