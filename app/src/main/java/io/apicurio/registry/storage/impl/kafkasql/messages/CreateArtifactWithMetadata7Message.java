...
@ToString
public class CreateArtifactWithMetadata7Message extends AbstractMessage {
    ...
    public Object dispatchTo(RegistryStorage storage) {
        ...
        return storage.createArtifactWithMetadata(groupId, artifactId, version, artifactType, handle, metaData, references);
    }
