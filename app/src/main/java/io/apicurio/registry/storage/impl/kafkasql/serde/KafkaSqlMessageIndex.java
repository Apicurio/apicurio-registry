...
public class KafkaSqlMessageIndex {
    ...
    static {
        indexMessageClasses(AppendVersionToBranch3Message.class, ConsumeDownload1Message.class,
                ...
                CreateGroup1Message.class, CreatePeer1Message.class, CreateRoleMapping3Message.class,
                CreateSnapshot1Message.class,
                DeleteAllExpiredDownloads0Message.class, DeleteAllOrphanedContent0Message.class,
                ...
                UpdateGroupMetaData2Message.class, UpdatePeer1Message.class, UpdateRoleMapping2Message.class,
