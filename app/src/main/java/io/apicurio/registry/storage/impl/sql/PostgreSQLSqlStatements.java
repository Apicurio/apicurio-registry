...
public class PostgreSQLSqlStatements extends CommonSqlStatements {
    ...
    public String upsertContent() {
        return "INSERT INTO content (tenantId, contentId, canonicalHash, contentHash, content) VALUES (?, ?, ?, ?, ?) ON CONFLICT (contentHash) DO NOTHING";
    }
    ...
    public String resetSequenceValue() {
        return "INSERT INTO sequences (tenantId, name, value) VALUES (?, ?, ?) ON CONFLICT (tenantId, name) DO UPDATE SET value = ? RETURNING value";
    }
