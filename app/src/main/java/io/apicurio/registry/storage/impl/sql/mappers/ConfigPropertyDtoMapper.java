 ...
 */
public class ConfigPropertyDtoMapper implements RowMapper<ConfigPropertyDto> {

    public static final ConfigPropertyDtoMapper instance = new ConfigPropertyDtoMapper();

    /**
     * Constructor.
     */
    private ConfigPropertyDtoMapper() {
    }
