...
public abstract class AbstractDataImporter implements DataImporter {
     ...
     */
    @Override
    public void importEntity(Entity entity) throws ReadOnlyStorageException {
    ...
    protected abstract void importArtifactRule(ArtifactRuleEntity entity) throws ReadOnlyStorageException;

    protected abstract void importArtifactVersion(ArtifactVersionEntity entity) throws ReadOnlyStorageException;

    protected abstract void importComment(CommentEntity entity) throws ReadOnlyStorageException;

    protected abstract void importContent(ContentEntity entity) throws ReadOnlyStorageException;

    protected abstract void importGlobalRule(GlobalRuleEntity entity) throws ReadOnlyStorageException;

    protected abstract void importGroup(GroupEntity entity) throws ReadOnlyStorageException;
}
