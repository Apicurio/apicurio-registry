...
CREATE TABLE tenants (tenantId VARCHAR(128) NOT NULL, createdBy VARCHAR(255), createdOn TIMESTAMP WITHOUT TIME ZONE NOT NULL, deploymentFlavor VARCHAR(255), organizationId VARCHAR(255) NOT NULL, status VARCHAR(255) );
