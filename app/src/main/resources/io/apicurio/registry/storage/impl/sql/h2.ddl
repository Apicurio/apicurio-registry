...
CREATE TABLE customrules (tenantId VARCHAR(128) NOT NULL, ruleId VARCHAR(32) NOT NULL, supportedArtifactType VARCHAR(32), customRuleType VARCHAR(32) NOT NULL, configuration VARCHAR(102400) NOT NULL, description VARCHAR(1024));
