...
CREATE TABLE global_rules (type NVARCHAR(32) NOT NULL, configuration TEXT NOT NULL, onFailure NVARCHAR(32) NOT NULL DEFAULT 'ERROR');
...
CREATE TABLE group_rules (groupId NVARCHAR(512) NOT NULL, type NVARCHAR(32) NOT NULL, configuration NVARCHAR(1024) NOT NULL, onFailure NVARCHAR(32) NOT NULL DEFAULT 'ERROR');
...
CREATE TABLE artifact_rules (groupId NVARCHAR(512) NOT NULL, artifactId NVARCHAR(512) NOT NULL, type NVARCHAR(32) NOT NULL, configuration NVARCHAR(1024) NOT NULL, onFailure NVARCHAR(32) NOT NULL DEFAULT 'ERROR');
