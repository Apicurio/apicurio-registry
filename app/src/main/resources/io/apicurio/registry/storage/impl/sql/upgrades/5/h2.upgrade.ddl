...
CREATE TABLE artifactreferences (tenantId VARCHAR(128) NOT NULL, groupId VARCHAR(512) NOT NULL, artifactId VARCHAR(512) NOT NULL, version VARCHAR(256), contentId BIGINT NOT NULL, name VARCHAR(512) NOT NULL);
