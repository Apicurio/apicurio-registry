...
public class SerdeMixTest extends AbstractResourceTestBase {
    ...
    public void testSerdeMix(Supplier<RegistryService> supplier) throws Exception {
        ...
        AvroKafkaDeserializer<GenericData.Record> deserializer1 = new AvroKafkaDeserializer<GenericData.Record>(supplier.get()).asLegacyId();
        ...
        AvroKafkaSerializer<GenericData.Record> serializer2 = new AvroKafkaSerializer<GenericData.Record>(supplier.get()).asLegacyId();
