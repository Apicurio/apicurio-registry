...
public class LoadBalanceRegistryClient implements RegistryClient {
    ...
    /**
     * @see RegistryClient#addArtifactVersionComment(String, String, String, io.apicurio.registry.rest.v2.beans.NewComment)
     */
    @Override
    ...
    /**
     * @see RegistryClient#editArtifactVersionComment(String, String, String, String, io.apicurio.registry.rest.v2.beans.NewComment)
     */
    @Override
