...
public class LimitsTest extends AbstractResourceTestBase {
    ...
    public void testLimits() throws Exception {
        ...
        clientV3.groups()
                ...
                .byGroupId("default").artifacts().byArtifactId(artifactId).versions().byVersion("1").meta()
                .put(meta).get(3, TimeUnit.SECONDS);
        ...
        var executionException1 = Assertions.assertThrows(ExecutionException.class, () -> {
            clientV3.groups().byGroupId("default").artifacts().byArtifactId(artifactId).versions()
                    .byVersion("1").meta().put(invalidmeta).get(3, TimeUnit.SECONDS);
        });
        ...
        var executionException2 = Assertions.assertThrows(ExecutionException.class, () -> {
            ...
            data.setContent("{}");
            clientV3.groups().byGroupId("default").artifacts().post(data, config -> {
