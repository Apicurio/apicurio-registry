...
public class ArtifactStateTest extends AbstractResourceTestBase {
    ...
    public void testSmoke() throws Exception {
        ...
        // disable latest
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).state()
                .put(toUpdateState(ArtifactState.DISABLED)).get(3, TimeUnit.SECONDS);

        VersionMetaData tvmd = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId)
                .versions().byVersion("3").meta().get().get(3, TimeUnit.SECONDS);
        ...
        ArtifactMetaData tamd = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId)
                .meta().get().get(3, TimeUnit.SECONDS);
        ...
        var executionException = assertThrows(ExecutionException.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).versions()
                    .byVersion("3").get().get(3, TimeUnit.SECONDS);
        });
        ...
        Assertions.assertEquals(404,
                ((io.apicurio.registry.rest.client.models.Error) executionException.getCause())
                        .getErrorCode());
        Assertions.assertEquals("VersionNotFoundException",
        ...
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).versions().byVersion("3")
                .meta().put(emd).get(3, TimeUnit.SECONDS);

        retry(() -> {
            VersionMetaData innerAvmd = clientV3.groups().byGroupId(groupId).artifacts()
                    .byArtifactId(artifactId).versions().byVersion("3").meta().get().get(3, TimeUnit.SECONDS);
        ...
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).versions().byVersion("3")
                .state().put(toUpdateState(ArtifactState.DEPRECATED)).get(3, TimeUnit.SECONDS);

        tamd = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).meta().get().get(3,
                TimeUnit.SECONDS);
        ...
        InputStream version = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId)
                .versions().byVersion("2").get().get(3, TimeUnit.SECONDS);
        Assertions.assertNotNull(version);
        version.close();

        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).meta().put(emd).get(3,
                TimeUnit.SECONDS); // should be allowed for deprecated

        retry(() -> {
            ArtifactMetaData innerAmd = clientV3.groups().byGroupId(groupId).artifacts()
        ...
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).versions().byVersion("3")
                .state().put(toUpdateState(ArtifactState.ENABLED)).get(3, TimeUnit.SECONDS);
        ...
        retry(() -> {
            ...
            VersionMetaData innerVmd = clientV3.groups().byGroupId(groupId).artifacts()
                    .byArtifactId(artifactId).versions().byVersion("1").meta().get().get(3, TimeUnit.SECONDS);
    ...
    void testEnableDisableArtifact() throws Exception {
        ...
        retry(() -> {
            // Get the meta-data
            ArtifactMetaData actualMD = clientV3.groups().byGroupId(groupId).artifacts()
                    .byArtifactId(artifactId).meta().get().get(3, TimeUnit.SECONDS);
        ...
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).state().put(state).get(3,
                TimeUnit.SECONDS);
        retry(() -> {
        ...
        retry(() -> {
            ...
            try {
                clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).get().get(3,
                        TimeUnit.SECONDS);
                Assertions.fail("ArtifactNotFoundException expected");
            } catch (ExecutionException ex) {
                assertNotNull(ex.getCause());
                assertEquals("ArtifactNotFoundException",
                        ((io.apicurio.registry.rest.client.models.Error) ex.getCause()).getName());
                // OK
            }
            ...
            VersionMetaData vmd = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId)
                    .versions().byVersion(String.valueOf(md.getVersion())).meta().get()
                    .get(3, TimeUnit.SECONDS);
        ...
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).versions()
                .byVersion(String.valueOf(md.getVersion())).state().put(state).get(3, TimeUnit.SECONDS);
        ...
        VersionMetaData vmd = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId)
                .versions().byVersion(String.valueOf(md.getVersion())).meta().get().get(3, TimeUnit.SECONDS);
    ...
    void testDeprecateDisableArtifact() throws Exception {
        ...
        retry(() -> {
            ...
            // and there is only a single version.
            try {
                clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).meta().get().get(3,
                        TimeUnit.SECONDS);
                Assertions.fail("ArtifactNotFoundException expected");
            } catch (ExecutionException ex) {
                assertNotNull(ex.getCause());
