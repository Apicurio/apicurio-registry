...
class McpRegistryCursorTest {
    ...
    @Test
    void testCursorFromDifferentFiltersIsRejected() {
        String cursor = McpRegistryCursor.encode(30, FILTERS);
    ...
    @Test
    void testMalformedCursorIsRejected() {
    ...
    @Test
    void testCursorFromAnOlderEncodingIsRejected() {
