...
public class BranchesTest extends AbstractResourceTestBase {
    ...
    public void testCreateBranch() throws Exception {
        ...
        BranchMetaData branch = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().post(createBranch);
    ...
    public void testCreateBranchWithVersions() throws Exception {
        ...
        VersionSearchResults versions = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("1.x").versions().get();
        Assertions.assertEquals(2, versions.getCount());
    ...
    public void testGetBranch() throws Exception {
        ...
        createBranch.setBranchId("1.x");
        createBranch.setDescription("Version 1.x");
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().post(createBranch);

        // Fetch that branch and assert
        BranchMetaData branch = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("1.x").get();
        Assertions.assertNotNull(branch);
        Assertions.assertEquals(groupId, branch.getGroupId());
        Assertions.assertEquals(artifactId, branch.getArtifactId());
        Assertions.assertEquals("1.x", branch.getBranchId());
        ...
        Assertions.assertThrows(Exception.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("invalid").get();
        });

        // Get a branch from an artifact that doesn't exist.
        Assertions.assertThrows(Exception.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId("invalid").branches().byBranchId("1.x").get();
        });
    }
    ...
    public void testGetBranches() throws Exception {
        ...
        BranchSearchResults results = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().get();
    ...
    public void testUpdateBranch() throws Exception {
        ...
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("1.x").put(update);

        // Check it now
        branch = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("1.x").get();
        Assertions.assertNotNull(branch);
        Assertions.assertEquals(groupId, branch.getGroupId());
        Assertions.assertEquals(artifactId, branch.getArtifactId());
        ...
        Assertions.assertThrows(Exception.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("invalid").put(update);
        });

        // Update a branch in an artifact that does not exist
        Assertions.assertThrows(Exception.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId("invalid").branches().byBranchId("1.x").put(update);
        });
    }
    ...
    public void testDeleteBranch() throws Exception {
        ...
        var results = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().get();
        Assertions.assertEquals(4, results.getCount());

        var bmd = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("2.x").get();
        Assertions.assertEquals("2.x", bmd.getBranchId());

        // Now delete branch 2.x
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("2.x").delete();
        ...
        Assertions.assertThrows(Exception.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("2.x").get();
        });

        // Try to delete a branch that does not exist
        Assertions.assertThrows(Exception.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("invalid").delete();
        });

        // Try to delete a branch of an artifact that does not exist
        Assertions.assertThrows(Exception.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId("invalid").branches().byBranchId("2.x").delete();
        });
    }
    ...
    public void testGetVersionsInBranch() throws Exception {
        ...
        var results = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("2-3").versions().get();
        ...
        results = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("2-4").versions().get();
        Assertions.assertEquals(3, results.getCount());
        ...
        results = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("5").versions().get();
        Assertions.assertEquals(1, results.getCount());
        Assertions.assertEquals("v5", results.getVersions().get(0).getName());

        // Get versions in a branch that does not exist.
        Assertions.assertThrows(Exception.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("invalid").versions().get();
        });

        // Get versions in a branch of an artifact that does not exist
        Assertions.assertThrows(Exception.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId("invalid").branches().byBranchId("2-4").versions().get();
        });
    }
    ...
    public void testReplaceBranchVersions() throws Exception {
        ...
        var results = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("test-branch").versions().get();
        Assertions.assertEquals(3, results.getCount());
        Assertions.assertEquals("v4", results.getVersions().get(0).getName());
        Assertions.assertEquals("v3", results.getVersions().get(1).getName());
        Assertions.assertEquals("v2", results.getVersions().get(2).getName());
        ...
        results = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("test-branch").versions().get();
        Assertions.assertEquals(3, results.getCount());
        Assertions.assertEquals("v5", results.getVersions().get(0).getName());
        Assertions.assertEquals("v3", results.getVersions().get(1).getName());
        ...
        Assertions.assertThrows(Exception.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("invalid-branch").versions().put(newVersions);
        });

        // Replace versions in a branch of an artifact that does not exist
        Assertions.assertThrows(Exception.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId("invalid").branches().byBranchId("test-branch").versions().put(newVersions);
        });
    ...
    public void testAppendVersionToBranch() throws Exception {
        ...
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("1-4").versions().post(addVersion("1"));
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("1-4").versions().post(addVersion("2"));
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("1-4").versions().post(addVersion("3"));
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("1-4").versions().post(addVersion("4"));

        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("2-3").versions().post(addVersion("2"));
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("2-3").versions().post(addVersion("3"));

        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("3-5").versions().post(addVersion("3"));
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("3-5").versions().post(addVersion("4"));
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("3-5").versions().post(addVersion("5"));

        // Check the results - make sure the versions are on the branches
        var results = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("1-4").versions().get();
        Assertions.assertEquals(4, results.getCount());
        Assertions.assertEquals("v4", results.getVersions().get(0).getName());
        Assertions.assertEquals("v3", results.getVersions().get(1).getName());
        Assertions.assertEquals("v2", results.getVersions().get(2).getName());
        ...
        results = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("2-3").versions().get();
        Assertions.assertEquals(2, results.getCount());
        Assertions.assertEquals("v3", results.getVersions().get(0).getName());
        Assertions.assertEquals("v2", results.getVersions().get(1).getName());

        results = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("3-5").versions().get();
        Assertions.assertEquals(3, results.getCount());
        Assertions.assertEquals("v5", results.getVersions().get(0).getName());
        ...
        Assertions.assertThrows(Exception.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("invalid").versions().post(addVersion("3"));
        });

        // Append a version to a branch of an artifact that does not exist
        Assertions.assertThrows(Exception.class, () -> {
            clientV3.groups().byGroupId(groupId).artifacts().byArtifactId("invalid").branches().byBranchId("2-3").versions().post(addVersion("3"));
        });
    }
    ...
    public void testGetMostRecentVersionFromBranch() throws Exception {
        ...
        VersionMetaData vmd = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).versions().byVersionExpression("branch=evens").get();
        Assertions.assertEquals("v4", vmd.getName());
        vmd = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).versions().byVersionExpression("branch=odds").get();
        ...
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("evens").versions().post(addVersion("6"));
        clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).branches().byBranchId("odds").versions().post(addVersion("5"));

        // Get the most recent version from each branch
        vmd = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).versions().byVersionExpression("branch=evens").get();
        Assertions.assertEquals("v6", vmd.getName());
        vmd = clientV3.groups().byGroupId(groupId).artifacts().byArtifactId(artifactId).versions().byVersionExpression("branch=odds").get();
