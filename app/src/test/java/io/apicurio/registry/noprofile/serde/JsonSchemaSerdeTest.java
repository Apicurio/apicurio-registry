...
public class JsonSchemaSerdeTest extends AbstractResourceTestBase {
    ...
    public void complexObjectValidation() throws Exception {
        ...
        final ArtifactMetaData amdAddress = client.groups().byGroupId("GLOBAL").artifacts()
                .post(content, config -> {
        ...
        final ArtifactMetaData amdEmail = client.groups().byGroupId("GLOBAL").artifacts()
                .post(content, config -> {
                    config.queryParameters.ifExists = "UPDATE";
                    config.queryParameters.canonical = false;
        ...
        final ArtifactMetaData amdPhone = client.groups().byGroupId("GLOBAL").artifacts()
                .post(content, config -> {
                    config.queryParameters.ifExists = "UPDATE";
                    config.queryParameters.canonical = false;
        ...
        client.groups().byGroupId("GLOBAL").artifacts().post(content, config -> {
            config.queryParameters.ifExists = "UPDATE";
            config.queryParameters.canonical = false;
        ...
        ArtifactMetaData global = client.groups().byGroupId("GLOBAL").artifacts()
                .byArtifactId("sample.account.json").meta().get().get();
