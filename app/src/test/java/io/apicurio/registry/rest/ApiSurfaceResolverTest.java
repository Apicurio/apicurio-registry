...
class ApiSurfaceResolverTest {
    ...
    void testResolveFromHttpServletRequest() {
        ...
        HttpServletRequest icebergRequest = mock(HttpServletRequest.class);
