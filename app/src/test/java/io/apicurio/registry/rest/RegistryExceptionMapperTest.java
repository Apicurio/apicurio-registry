...
class RegistryExceptionMapperTest {
    ...
    void setUp() {
        ...
        coreMapper = mock(CoreRegistryExceptionMapperService.class);
        coreV2Mapper = mock(CoreV2RegistryExceptionMapperService.class);
        ccompatMapper = mock(CCompatExceptionMapperService.class);
        icebergMapper = mock(IcebergExceptionMapperService.class);
