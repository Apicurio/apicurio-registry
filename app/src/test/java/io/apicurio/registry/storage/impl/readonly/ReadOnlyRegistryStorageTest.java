...
public class ReadOnlyRegistryStorageTest {
    ...
    static {
        EXPECTED_METHODS = Map.<String, State>ofEntries(
                ...
                entry("createArtifactVersion6", new State(true, s -> s.createArtifactVersion(null, null, null, null, null, null))),
                ...
                entry("createArtifactVersionWithMetadata7", new State(true, s -> s.createArtifactVersionWithMetadata(null, null, null, null, null, null, null))),
