...
public class ReadOnlyRegistryStorageTest {
    ...
    static {
        EXPECTED_METHODS = Map.<String, State>ofEntries(
                // Keep alphabetical
                entry("appendVersionToBranch3", new State(true, s -> s.appendVersionToBranch(null, null, null))),
                ...
                entry("getArtifactVersions3", new State(false, s -> s.getArtifactVersions(null, null, RegistryStorage.RetrievalBehavior.DEFAULT))),
                ...
                entry("replaceBranchVersions3", new State(true, s -> s.replaceBranchVersions(null, null, null))),
                ...
                entry("updateBranchMetaData3", new State(true, s -> s.updateBranchMetaData(null, null, null))),
