...
public class ReadOnlyRegistryStorageTest extends AbstractResourceTestBase {
    ...
    static {
        EXPECTED_METHODS = Map.<String, State> ofEntries(
                ...
                entry("createPeer1", new State(true, s -> s.createPeer(null))),
                ...
                entry("deletePeer1", new State(true, s -> s.deletePeer(null))),
                ...
                entry("getPeer1", new State(false, s -> s.getPeer(null))),
                entry("getPeers0", new State(false, RegistryStorage::getPeers)),
                ...
                entry("isPeerExists1", new State(false, s -> s.isPeerExists(null))),
                ...
                entry("searchPeers2", new State(false, s -> s.searchPeers(0, 20))),
                ...
                entry("updatePeer1", new State(true, s -> s.updatePeer(null))),
                ...
                entry("getUsageSummaryCounts3",
                        new State(false, s -> s.getUsageSummaryCounts(0, 0, 0))),
                ...
                entry("updateContractMetadata4",
                        new State(true, s -> s.updateContractMetadata(null, null, null, null))),
                entry("transitionContractStatus6",
                        new State(true,
                                s -> s.transitionContractStatus(null, null, null, null, null, null))),
