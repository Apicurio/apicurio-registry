...
public record SearchFilterData(
        ...
        Set<String> deniedPrefixResources,
        boolean allowAll) {

    public static SearchFilterData all() {
        return new SearchFilterData(Set.of(), Set.of(), Set.of(), Set.of(), true);
    }

    public static SearchFilterData none() {
        return new SearchFilterData(Set.of(), Set.of(), Set.of(), Set.of(), false);
    }
    ...
    public boolean hasDenyFilters() {
        return !deniedExactResources.isEmpty() || !deniedPrefixResources.isEmpty();
    }
}
