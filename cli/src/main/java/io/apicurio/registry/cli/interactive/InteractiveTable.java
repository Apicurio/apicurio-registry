...
/**
 * Interactive terminal table component.
 * <p>
 * [Experimental] Subject to backwards-incompatible change or removal.
 */
...
public class InteractiveTable<T> {
    ...
    KeyMap<String> buildNormalKeyMap(Terminal terminal) {
        KeyMap<String> keyMap = new KeyMap<>();
        keyMap.bind("UP", KeyMap.key(terminal, Capability.key_up), "\033[A", "\033OA");
        keyMap.bind("DOWN", KeyMap.key(terminal, Capability.key_down), "\033[B", "\033OB");
