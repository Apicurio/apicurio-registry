...
public final class InteractiveUtil {
    ...
    public static final Function<SearchedArtifact, String> ARTIFACT_ROW_RENDERER =
            a -> Optional.ofNullable(a.getName()).orElse(a.getArtifactId()) + "  " + a.getArtifactType() + "  " + convertToString(a.getCreatedOn());
    ...
    static void printArtifactDetails(SearchedArtifact a, StringBuilder stdout) {
        ...
        table.addRow(GROUP_ID, displayGroupId(a.getGroupId()));
        table.addRow(ARTIFACT_ID, a.getArtifactId());
        table.addRow(NAME, Optional.ofNullable(a.getName()).orElse(a.getArtifactId()));
        table.addRow(ARTIFACT_TYPE, a.getArtifactType());
        table.addRow(DESCRIPTION, Optional.ofNullable(a.getDescription()).orElse(""));
        table.addRow(CREATED_ON, convertToString(a.getCreatedOn()));
        table.addRow(OWNER, a.getOwner());
        table.addRow(MODIFIED_ON, convertToString(a.getModifiedOn()));
        table.addRow(MODIFIED_BY, a.getModifiedBy());
        table.addRow(LABELS, convertToString(a.getLabels()));
        table.print(stdout);
    }
}
