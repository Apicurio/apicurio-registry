...
class InteractiveTableStateTest {
    ...
    @Test
    void testMoveUpAtTopStaysAtZero() {
    ...
    @Test
    void testMoveDownAtBottomStaysAtLast() {
        var state = newState("alpha", "beta");
        state.moveDown();
        state.moveDown();
        state.moveDown();
    ...
    @Test
    void testMoveOnEmptyListIsNoOp() {
        var state = newState();
        state.moveDown();
        state.moveUp();
        assertThat(state.getSelectedIndex()).isZero();
    ...
    @Test
    void testGetSelectedRowReturnsNullWhenEmpty() {
        var state = newState();
        assertThat(state.getSelectedRow()).isNull();
    }

    @Test
    void testGetSelectedRowReturnsCorrectRow() {
        var state = newState("alpha", "beta", "gamma");
        state.moveDown();
    ...
    @Test
    void testStartFilterInputSetsMode() {
        var state = newState("alpha", "beta");
    ...
    @Test
    void testTypeFilterCharNarrowsRowsCaseInsensitive() {
    ...
    @Test
    void testBackspaceFilterCharWidensRows() {
        var state = newState("Apple", "Banana", "Apricot");
        state.startFilterInput();
        state.typeFilterChar('a');
        state.typeFilterChar('p');
    ...
    @Test
    void testCommitFilterReturnsToNormalModeKeepingFilteredRows() {
        var state = newState("Apple", "Banana", "Apricot");
        state.startFilterInput();
        state.typeFilterChar('a');
        state.typeFilterChar('p');
    ...
    @Test
    void testClearFilterResetsEverything() {
        var state = newState("Apple", "Banana", "Apricot");
        state.startFilterInput();
        state.typeFilterChar('a');
        state.moveDown();
    ...
    @Test
    void testSetRowsReappliesFilter() {
        var state = newState("alpha", "beta", "gamma");
        state.moveDown();
        state.startFilterInput();
        state.typeFilterChar('a');
    ...
    @Test
    void testFilterWithNoMatchesLeavesEmptyRows() {
    ...
    @Test
    void testStartConfirmDeleteSetsModeWhenRowsPresent() {
        var state = newState("Apple", "Banana");
    ...
    @Test
    void testStartConfirmDeleteNoOpWhenEmpty() {
        var state = newState();
        state.startConfirmDelete();
        assertThat(state.getMode()).isEqualTo(InteractiveTableState.Mode.NORMAL);
    }
    ...
    @Test
    void testCustomRowSearcherFiltering() {
