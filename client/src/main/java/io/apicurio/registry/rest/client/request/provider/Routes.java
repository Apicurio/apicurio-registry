...
public class Routes {
    ...
    protected static final String ARTIFACT_VERSION_COMMENTS = ARTIFACT_VERSION + "/comments";
    protected static final String ARTIFACT_VERSION_COMMENT = ARTIFACT_VERSION_COMMENTS + "/%s";
