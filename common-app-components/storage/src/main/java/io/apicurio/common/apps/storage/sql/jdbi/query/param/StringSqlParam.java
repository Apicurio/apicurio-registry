 ...
 */
public class StringSqlParam extends SqlParam<String> {

    public StringSqlParam(int position, String value) {
    ...
    public void bindTo(PreparedStatement statement) {
        try {
            if (value == null) {
                statement.setNull(position + 1, Types.VARCHAR); // TODO Check
            } else {
