...
public class PropertiesUtil {
     ...
     *
     * @param ip the injection point annotated with {@link ApplicationProperties}
    ...
    public static Properties properties(InjectionPoint ip) {
        ...
        if (prefixes.length == 0) {
            throw new IllegalArgumentException("Annotation @ApplicationProperties on " + ip.getMember()
