...
/**
 * Base class for applications that want to have a configurable redirect setup. Typically this class would be
 * extended and configured using something like @ConfigProperty
 *
