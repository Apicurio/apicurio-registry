...
/**
 * Switches on every agent registry feature flag, including the UI's Agents tab. Shared by core's tests
 * (agents absent) and the agents module's tests (agents deployed), so the only difference between the
 * two is whether the code is present.
 */
