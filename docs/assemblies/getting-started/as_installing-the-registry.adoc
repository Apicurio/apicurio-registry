...
This chapter explains how to first install {registry} and then how to set up your chosen storage option: AMQ Streams, embedded Infinispan, or PostgreSQL database.
