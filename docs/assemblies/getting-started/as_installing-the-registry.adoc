...
This chapter explains how to first install {registry} and then how to set up your chosen registry storage option: AMQ Streams, embedded Infinispan, or PostgreSQL database. This chapter also explains how to configure optional settings for readiness and liveness probes on OpenShift.
...
.OpenShift readiness and liveness
* xref:configuring-liveness-readiness-probes[]
[IMPORTANT]
====
