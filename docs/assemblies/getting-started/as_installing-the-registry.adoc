...
This topic explains how to install and run the {registry} container image with the following storage options:
...
include::../../modules/getting-started/p_installing-registry-kafka-kubernetes-storage.adoc[leveloffset=+1]
endif::[]
