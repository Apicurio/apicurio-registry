...
include::../../modules/getting-started/proc-installing-registry-operatorhub.adoc[leveloffset=+1]
include::../../modules/getting-started/proc-installing-kafka-streams-operatorhub.adoc[leveloffset=+1]
include::../../modules/getting-started/proc-setting-up-kafka-streams-storage.adoc[leveloffset=+1]
include::../../modules/getting-started/proc-setting-up-infinispan-storage.adoc[leveloffset=+1]
include::../../modules/getting-started/proc-installing-postgresql-operatorhub.adoc[leveloffset=+1]
include::../../modules/getting-started/proc-setting-up-postgresql-storage.adoc[leveloffset=+1]
