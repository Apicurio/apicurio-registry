...
//INCLUDES
include::../../modules/getting-started/proc-adding-artifacts-using-console.adoc[leveloffset=+1]
include::../../modules/getting-started/proc-browsing-artifacts-using-console.adoc[leveloffset=+1]
include::../../modules/getting-started/proc-configuring-rules-using-console.adoc[leveloffset=+1]
