...
[role="_abstract"]
This chapter explains how to manage schema and API artifacts stored in {registry} by using the {registry} web console. This includes uploading and browsing {registry} content, and configuring optional rules:
