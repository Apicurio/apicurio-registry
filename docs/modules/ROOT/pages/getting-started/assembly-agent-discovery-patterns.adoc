...
* xref:assembly-a2a-features_{context}[]
...
Name-based search:: You can filter agents by name by using partial matching. {registry} matches the `name` parameter against the artifact name:
+
[source,bash]
----
