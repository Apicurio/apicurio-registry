...
[role="_abstract"]
This chapter provides detailed information on how to configure Kafka client SerDes in your producer and consumer client applications:

* xref:registry-serdes-concepts-constants-{context}[]
* xref:registry-serdes-config-props-{context}[]
