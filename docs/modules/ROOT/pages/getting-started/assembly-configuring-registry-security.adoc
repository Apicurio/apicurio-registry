...
* xref:configuring-resource-authorization_{context}[]
...
// proc-registry-cors-configuration
:_mod-docs-content-type: PROCEDURE
...
// proc-registry-cors-authentication
:_mod-docs-content-type: PROCEDURE
