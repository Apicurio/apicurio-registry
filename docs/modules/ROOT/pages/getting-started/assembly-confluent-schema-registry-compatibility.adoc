...
|Use {registry} native Data Contracts feature (`apicurio.contracts.enabled=true`) for contract metadata and rulesets.
|===
...
* xref:getting-started/assembly-data-contracts.adoc[Data Contracts]
