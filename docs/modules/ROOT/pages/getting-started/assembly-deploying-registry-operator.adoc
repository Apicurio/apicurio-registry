...
This section explains how to deploy {registry} with KubernetesOps storage. KubernetesOps is a read-only storage
...
* For detailed configuration options, see xref:getting-started/assembly-configuring-kubernetesops-storage.adoc[].
