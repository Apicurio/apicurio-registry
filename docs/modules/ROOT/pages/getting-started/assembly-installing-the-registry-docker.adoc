...
include::{mod-loc}getting-started/proc-installing-registry-jpa-storage.adoc[leveloffset=+1]
include::{mod-loc}getting-started/proc-installing-registry-infinispan-storage.adoc[leveloffset=+1]
