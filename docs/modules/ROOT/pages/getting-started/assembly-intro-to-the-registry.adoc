...
* https://github.com/Apicurio/apicurio-registry/tree/main/examples/serdes-with-references[Apicurio Registry SerDes with references demonstration]
...
.Additional resources
* link:https://github.com/Apicurio/apicurio-registry[]
* link:https://github.com/Apicurio/apicurio-registry/tree/main/operator[]
