...
[role="_abstract"]
{registry} is a datastore for sharing standard event schemas and API designs across event-driven and API architectures. Learn about key {registry} concepts, artifact types, and available integrations:
...
* https://github.com/Apicurio/apicurio-registry/tree/main/examples/serdes-with-references[{registry} SerDes with references example]



// Metadata created by nebel

// con-registry-web-console
