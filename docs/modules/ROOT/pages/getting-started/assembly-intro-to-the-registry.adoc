...
[role="_additional-resources"]
.Additional resources
* link:https://github.com/Apicurio/apicurio-registry[Building from source code and running Docker images]
* link:https://github.com/Apicurio/apicurio-registry/tree/main/operator[Using the Operator to deploy]
