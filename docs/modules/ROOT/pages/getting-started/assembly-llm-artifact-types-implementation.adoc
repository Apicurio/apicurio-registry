...
You can find the JSON Schemas in `app/src/agents/resources/schemas/`:
...
The `PromptRenderingService` class (`app/src/agents/java/io/apicurio/registry/services/PromptRenderingService.java`) includes the following features:
