...
The LLM artifact types form a native Java artifact type system consisting of the following components:
...
You can find the JSON Schemas in `agents/src/main/resources/schemas/`:
...
The `PromptRenderingService` class (`agents/src/main/java/io/apicurio/registry/services/PromptRenderingService.java`) includes the following features:
