...
//INCLUDES
include::../../modules/getting-started/proc-managing-artifacts-using-rest-api.adoc[leveloffset=+1]
include::../../modules/getting-started/proc-managing-artifacts-using-maven-plugin.adoc[leveloffset=+1]
include::../../modules/getting-started/proc-managing-artifacts-using-client-code.adoc[leveloffset=+1]
