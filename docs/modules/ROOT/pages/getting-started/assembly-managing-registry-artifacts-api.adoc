...
Use the Core Registry API v3 to export and import data in `.zip` format between {registry} instances. All the artifact data contained in the {registry} instance is exported in the `.zip` file.
