...
mvn io.apicurio:apicurio-registry-maven-plugin:${apicurio.version}:register \
  ...
  -Dartifacts.0.references.0.name=/apis/registry/v3/groups/master/artifacts/kafka-bindings.yml/versions/branch=latest/content#/components/messageTraits/kafkaKeyString \
