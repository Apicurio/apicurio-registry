...
. To delete an artifact or artifact version, see xref:deleting-artifacts-using-console_{context}[].
...
== Deleting artifacts and artifact versions using the {registry} web console

[role="_abstract"]
You can use the {registry} web console to delete artifacts and artifact versions stored in {registry}. You can delete an entire artifact, which removes all versions of that artifact, or delete a specific artifact version.

IMPORTANT: Deletion of artifacts and artifact versions is disabled by default in {registry}. You must enable deletion in the {registry} web console *Settings* before you can delete artifacts or artifact versions.
...
[discrete]
=== Enabling artifact and artifact version deletion

Before you can delete artifacts or artifact versions, you must enable the deletion settings in the {registry} web console.
...
+
NOTE: Both settings are disabled by default. You can enable either or both settings depending on your requirements.
