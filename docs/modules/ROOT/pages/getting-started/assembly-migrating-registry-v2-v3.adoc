...
. *Phase 1 — Preparation:* Deploy the load balancer.
+
--
...
. *Phase 2 — Pre-migration validation:* Enable read-only mode.
+
--
...
. *Phase 3 — Data migration:* Export data from {registry-v2}.
+
--
...
. *Phase 4 — Traffic switch:* Switch the load balancer to {registry} 3.x.
+
--
...
. *Phase 5 — Post-migration validation:* Test v2 API backward compatibility.
+
--
...
. *Phase 6 — Stabilization:* Monitor and observe.
+
--
...
== Detailed configuration property mappings
