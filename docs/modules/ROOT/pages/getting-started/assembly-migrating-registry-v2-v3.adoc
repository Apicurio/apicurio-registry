...
----
+
For a detailed comparison of all changed properties, see the client migration configuration reference.
...
NOTE: This procedure covers the legacy `apicurio-registry-client` (2.6.13.Final) product client. If your application instead uses the Kiota-generated `client-v2` module (Maven artifact `apicurio-registry-v2-java-sdk`, class `RegistryV2ClientFactory`), see the link:https://github.com/Apicurio/apicurio-registry/blob/main/java-sdk/MIGRATING_FROM_V2.md[Java SDK v2 to v3 migration guide] instead.
...
----
+
For a detailed comparison of all authentication changes, see the client migration configuration reference.
...
+
For a complete list of available properties, see the user interface configuration properties reference.
