...
== SQL database storage high availability
:_mod-docs-content-type: CONCEPT
...
.KafkaSQL topic descriptions
[cols="2,1,3", options="header"]
|===
|Topic |Default name |Purpose
...
.Configuration changes required when upgrading to management port 9000
[cols="2,3", options="header"]
|===
|Component |Required change

|Kubernetes health probes
a|Update liveness and readiness probe definitions to target port `9000`. The endpoint paths remain the same.
