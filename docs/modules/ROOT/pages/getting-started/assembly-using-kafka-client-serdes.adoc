...
props.putIfAbsent(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG,
    AvroKafkaDeserializer.class.getName());
----
. The deserializer provided by {registry}.
...
----
. The serializer for the message key provided by {registry}.
. The serializer for the message value provided by {registry}.
...
----
+
. The Avro serializer provided by {registry}.
. The Avro deserializer provided by {registry}.
. Configures the {registry} URL and the Avro reader for deserialization in Avro format.
