...
deserializer can be configured in the following ways:
...
The JSON Schema serializer class can be configured in the following ways:
...
The JSON Schema deserializer class can be configured in the following ways:
