...
+
. For global rules, click the *Global rules* tab at the top left of your {registry} instance, and click *Enable* to configure a global validity rule or compatibility rule for all artifact content, and select the appropriate rule configuration from the list. 
