...
IMPORTANT: You can import {registry} data that has been exported from another {product-long-registry} instance. You cannot currently import {registry} data from a Red Hat Integration {registry} instance.   
endif::[]
