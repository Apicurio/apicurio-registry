...
There are some cases where storing artifact content with the referenced content inline might be helpful. For these cases, the Core Registry API v2 supports the `dereference` parameter in certain operations. 
