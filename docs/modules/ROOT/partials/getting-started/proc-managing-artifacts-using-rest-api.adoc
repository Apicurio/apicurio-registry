...
IMPORTANT: When adding artifacts using the v2 REST API, if you do not want to specify a unique group ID, specify `../groups/default` in the API path. If you do not specify a unique artifact ID, {registry} generates one automatically as a UUID.
