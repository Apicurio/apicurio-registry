...
* For more details on the export tool for migrating from version 1.x to 2.x, see the link:https://github.com/Apicurio/apicurio-registry/tree/2.2.x/utils/exportV1[Apicurio Registry export utility for 1.x versions].
