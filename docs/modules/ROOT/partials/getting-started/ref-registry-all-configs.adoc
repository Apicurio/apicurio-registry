...
|Available from
|Description
|`apicurio.mcp-registry.enabled`
|`boolean`
|`false`
|`3.4.0`
|Enable the MCP Registry API (Developer Preview) _(experimental)_
|`apicurio.mcp-registry.max-page-size`
|`int`
|`100`
|`3.4.0`
|Maximum number of MCP servers returned by a single list request
