...
|`false`
|`3.0.0`
|Enable per-resource authorization using grants file _(experimental)_
|`apicurio.auth.resource-based-authorization.grants.path`
|`optional<string>`
|
|`3.0.0`
|Path to the JSON grants data file (hot-reloaded on change) _(experimental)_
|`apicurio.auth.resource-based-authorization.grants.reload-every`
|`string`
|`5s`
|`3.0.0`
|Interval for checking grants file changes. Set to 'off' to disable hot-reload. _(experimental)_
...
|`false`
|`3.2.0`
|Enable data contracts support _(experimental)_
|===
...
|`apicurio.ui.auth.oidc.url`
|`optional<string>`
|
|`3.0.0`
|The OIDC URL exposed to the browser (overrides quarkus.oidc.auth-server-url in uiConfig)
