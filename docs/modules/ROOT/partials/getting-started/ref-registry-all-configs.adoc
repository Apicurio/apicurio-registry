...
|`5`
|`3.4.0`
|Number of consecutive Kubernetes TokenReview API failures after which the circuit breaker opens and TokenReview calls are temporarily skipped. _(experimental)_
