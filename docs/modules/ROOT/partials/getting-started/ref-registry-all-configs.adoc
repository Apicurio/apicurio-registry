...
|
|`3.1.0`
|Comma-separated Kubernetes groups that map to sr-admin role
|`apicurio.auth.role-source.kubernetes.group-mapping.developer`
|`string`
|
|`3.1.0`
|Comma-separated Kubernetes groups that map to sr-developer role
|`apicurio.auth.role-source.kubernetes.group-mapping.readonly`
|`string`
|
|`3.1.0`
|Comma-separated Kubernetes groups that map to sr-readonly role
...
|
|`3.1.0`
|Comma-separated list of API audiences for TokenReview validation. If empty, audience is not validated.
|`apicurio.authn.kubernetes.cache-expiration`
|`int`
|`5`
|`3.1.0`
|TokenReview result cache expiration in minutes
|`apicurio.authn.kubernetes.enabled`
|`boolean`
|`false`
|`3.1.0`
|Enable Kubernetes TokenReview authentication
