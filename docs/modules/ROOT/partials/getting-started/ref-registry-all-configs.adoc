...
|`apicurio.authn.proxy-header.strict`
|`boolean [dynamic]`
|`false`
|`3.1.7`
|Require proxy headers when proxy authentication is enabled
...
|`apicurio.authn.public-paths`
|`optional<string>`
|
|`3.1.0.Final`
|Comma-separated list of URL path patterns that should be accessible without authentication (e.g., /health/*,/metrics/*)
