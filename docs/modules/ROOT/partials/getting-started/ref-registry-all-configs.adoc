...
|Available from
|Description
|`apicurio.search.lucene.enabled`
|`boolean`
|`false`
|`3.2.0`
|Enable search indexing
|`apicurio.search.lucene.full-rebuild-threshold`
|`int`
|`1000`
|`3.2.0`
|Threshold to reach before a full search index rebuild is required
|`apicurio.search.lucene.index-path`
|`optional<string>`
|
|`3.2.0`
|Path to where the search index file should be written
|`apicurio.search.lucene.polling-initial-delay`
|`duration`
|`10s`
|`3.2.0`
|Initial delay before the first asynchronous search index poll
|`apicurio.search.lucene.polling-interval`
|`duration`
|`30s`
|`3.2.0`
|Asynchronous search index update polling interval
|`apicurio.search.lucene.ram-buffer-size-mb`
|`int`
|`256`
|`3.2.0`
|Search index RAM buffer size (in MB)
|`apicurio.search.lucene.update-mode`
|`string`
|`AUTO`
|`3.2.0`
|Search index update mode (AUTO, SYNCHRONOUS, ASYNCHRONOUS)
|===
