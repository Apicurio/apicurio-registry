...
// ^^^
// TODO: The default value in DefaultSchemaResolverConfig is
// `io.apicurio.registry.resolver.strategy.DynamicArtifactReferenceResolverStrategy`
// from `io.apicurio.registry.resolver.SchemaResolverConfig.ARTIFACT_RESOLVER_STRATEGY_DEFAULT`.
// But the documentation specifies `io.apicurio.registry.serde.strategy.TopicIdStrategy`,
// which is redefined here `io.apicurio.registry.serde.SerdeConfig.ARTIFACT_RESOLVER_STRATEGY_DEFAULT`
// Is this OK?
...
// TODO: Should this mention the DefaultSchemaResolver config?
// The following properties are defined in io/apicurio/registry/serde/SerdeConfig.java
