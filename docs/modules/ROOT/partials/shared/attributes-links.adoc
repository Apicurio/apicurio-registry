...
:LinkServiceRegistryInstall: https://access.redhat.com/documentation/en-us/red_hat_integration/{version}/html-single/installing_and_deploying_service_registry_on_openshift/index
:NameServiceRegistryInstall: Installing and deploying Service Registry on OpenShift

:LinkServiceRegistryUser: https://access.redhat.com/documentation/en-us/red_hat_integration/{version}/html-single/service_registry_user_guide/index
:NameServiceRegistryUser: Service Registry User Guide

:LinkServiceRegistryMigration: https://access.redhat.com/documentation/en-us/red_hat_integration/{version}/html-single/migrating_service_registry/index
:NameServiceRegistryMigration: Migrating Service Registry
