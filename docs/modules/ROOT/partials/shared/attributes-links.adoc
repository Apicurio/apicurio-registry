...
:LinkServiceRegistryRESTAPI: https://access.redhat.com/webassets/avalon/d/Red_Hat_Integration-2023.q2-Service_Registry_User_Guide-en-US/files/registry-rest-api.htm
