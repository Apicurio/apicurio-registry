...
:registry-version: 3.3
:registry-release: 3.3.0
...
:registry: Apicurio Registry
:registry-version: 3.3
:registry-release: 3.3.0-redhat-00001
...
:installing-the-registry-storage-openshift: xref:installing-registry-storage_{context}[]
