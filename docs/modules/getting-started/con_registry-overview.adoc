...
{registry} is a datastore for standard event schemas and API designs. You can use {registry} to decouple the structure of your data from your applications and to share and manage your data structures and API descriptions at runtime using a REST interface. 
