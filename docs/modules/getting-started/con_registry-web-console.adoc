...
The {registry} web console is available from the main endpoint of your {registry} deployment, for example, on  `\http://MY-REGISTRY-URL/ui`. For more details, see xref:managing-registry-artifacts-ui[].
