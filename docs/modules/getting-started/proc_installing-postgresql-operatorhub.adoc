...
. In the *Filter by keyword* text box, enter `PostgreSQL` to find your an Operator suitable for your environment, for example, *Crunchy PostgreSQL for OpenShift* or *PostgreSQL Operator by Dev4Ddevs.com*.
