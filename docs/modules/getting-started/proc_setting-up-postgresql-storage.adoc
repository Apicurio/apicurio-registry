...
* You must have already installed a PostgreSQL database system, which is available from OpenShift. For examaple, see xref:installing-postgresql-operatorhub[].
