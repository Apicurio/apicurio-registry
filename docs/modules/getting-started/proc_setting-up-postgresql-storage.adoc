...
= Configuring {registry} with PostgreSQL database storage 
...
+
NOTE: If you have deployed a PostgreSQL database Operator in another way, you can still use your database with the {registry} Operator, but you must create the required database configuration shown in this section. See your PostgreSQL documentation for more details.
