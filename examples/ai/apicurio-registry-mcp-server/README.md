...
3. Build the Apicurio Registry MCP server:
   ...
   ```json
   {
     "mcpServers": {
       "Apicurio Registry": {
         ...
         "args": [
           "-jar",
           "/home/user/repositories/apicurio-registry/examples/ai/apicurio-registry-mcp-server/target/apicurio-registry-mcp-server-0.0.1-SNAPSHOT-runner.jar"
         ]
       }
     }
   }
