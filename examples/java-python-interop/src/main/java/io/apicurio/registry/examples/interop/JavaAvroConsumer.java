...
/**
 * Java Avro Consumer for the Java-Python interoperability example.
 * <p>
...
public class JavaAvroConsumer {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("=== Java Avro Consumer (for Python Producer messages) ===");
            ...
            while (messageCount < expectedMessages) {
                ...
                if (records.count() == 0) {
                    ...
                    for (var record : records) {
                        ...
                        String sender = value.get("sender").toString();
                        String source = value.get("source").toString();
    ...
    private static KafkaConsumer<String, GenericRecord> createKafkaConsumer() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "JavaAvroConsumer");
