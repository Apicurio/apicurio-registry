...
// ContractsRequestBuilder builds and executes requests for operations under \admin\contracts
...
func NewContractsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter) *ContractsRequestBuilder {
	m := &ContractsRequestBuilder{
		BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/contracts", pathParameters),
	}
	return m
}
...
// Ruleset manage the global contract ruleset.
// returns a *ContractsRulesetRequestBuilder when successful
func (m *ContractsRequestBuilder) Ruleset() *ContractsRulesetRequestBuilder {
	return NewContractsRulesetRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
