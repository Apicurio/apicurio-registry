...
// AgentCapabilities capabilities of an A2A agent.
type AgentCapabilities struct {
	// Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
	additionalData map[string]any
	// The extendedAgentCard property
	extendedAgentCard *bool
	// The extensions property
	extensions []AgentExtensionable
	// The pushNotifications property
...
// GetExtendedAgentCard gets the extendedAgentCard property value. The extendedAgentCard property
...
// GetPushNotifications gets the pushNotifications property value. The pushNotifications property
// returns a *bool when successful
...
// SetExtendedAgentCard sets the extendedAgentCard property value. The extendedAgentCard property
...
// SetPushNotifications sets the pushNotifications property value. The pushNotifications property
