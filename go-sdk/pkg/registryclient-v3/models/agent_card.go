...
type AgentCard struct {
	...
	// The defaultInputModes property
	defaultInputModes []string
	// The defaultOutputModes property
...
// GetDefaultInputModes gets the defaultInputModes property value. The defaultInputModes property
// returns a []string when successful
func (m *AgentCard) GetDefaultInputModes() []string {
	return m.defaultInputModes
}

// GetDefaultOutputModes gets the defaultOutputModes property value. The defaultOutputModes property
// returns a []string when successful
...
// GetProtocolVersion gets the protocolVersion property value. The protocolVersion property
// returns a *string when successful
func (m *AgentCard) GetProtocolVersion() *string {
	return m.protocolVersion
}

// GetProvider gets the provider property value. Provider of an A2A agent.
...
func (m *AgentCard) GetSecurityRequirements() []AgentSecurityRequirementable {
	return m.securityRequirements
}

// GetSecuritySchemes gets the securitySchemes property value. The securitySchemes property
...
// SetDefaultInputModes sets the defaultInputModes property value. The defaultInputModes property
func (m *AgentCard) SetDefaultInputModes(value []string) {
	m.defaultInputModes = value
}

// SetDefaultOutputModes sets the defaultOutputModes property value. The defaultOutputModes property
...
// SetProtocolVersion sets the protocolVersion property value. The protocolVersion property
func (m *AgentCard) SetProtocolVersion(value *string) {
	m.protocolVersion = value
}

// SetProvider sets the provider property value. Provider of an A2A agent.
...
func (m *AgentCard) SetSecurityRequirements(value []AgentSecurityRequirementable) {
	m.securityRequirements = value
}

// SetSecuritySchemes sets the securitySchemes property value. The securitySchemes property
