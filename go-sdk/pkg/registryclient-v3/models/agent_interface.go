...
// AgentInterface interface endpoint for an A2A agent.
type AgentInterface struct {
	// Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
	additionalData map[string]any
	// The protocolBinding property
...
// GetProtocolBinding gets the protocolBinding property value. The protocolBinding property
...
// SetProtocolBinding sets the protocolBinding property value. The protocolBinding property
