...
// AgentSearchRequest request body for advanced agent search.
type AgentSearchRequest struct {
	// Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
	additionalData map[string]any
	// Filters for advanced agent search.
...
// GetFilters gets the filters property value. Filters for advanced agent search.
...
// SetFilters sets the filters property value. Filters for advanced agent search.
