...
type ConsumerVersionEntry struct {
    ...
    clientId *string
    // The driftAlert property
    driftAlert *bool
    // The versions property
    versions ConsumerVersionEntry_versionsable
    // The versionsBehind property
...
// GetDriftAlert gets the driftAlert property value. The driftAlert property
...
// GetVersionsBehind gets the versionsBehind property value. The versionsBehind property
...
// SetDriftAlert sets the driftAlert property value. The driftAlert property
...
// SetVersionsBehind sets the versionsBehind property value. The versionsBehind property
