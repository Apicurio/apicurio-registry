...
// GetDead gets the dead property value. The dead property
// returns a *int32 when successful
...
// GetStale gets the stale property value. The stale property
// returns a *int32 when successful
...
// SetDead sets the dead property value. The dead property
func (m *UsageSummary) SetDead(value *int32)() {
    m.dead = value
}
// SetStale sets the stale property value. The stale property
