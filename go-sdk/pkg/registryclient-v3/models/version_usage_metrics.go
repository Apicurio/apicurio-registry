...
type VersionUsageMetrics struct {
    ...
    clients []string
    // The firstFetchedOn property
    firstFetchedOn *int64
    // The globalId property
    globalId *int64
    // The lastFetchedOn property
    lastFetchedOn *int64
    // The totalFetches property
    totalFetches *int64
    // The uniqueClients property
    uniqueClients *int32
...
// GetFirstFetchedOn gets the firstFetchedOn property value. The firstFetchedOn property
...
// GetLastFetchedOn gets the lastFetchedOn property value. The lastFetchedOn property
// returns a *int64 when successful
func (m *VersionUsageMetrics) GetLastFetchedOn()(*int64) {
    return m.lastFetchedOn
}
// GetTotalFetches gets the totalFetches property value. The totalFetches property
// returns a *int64 when successful
func (m *VersionUsageMetrics) GetTotalFetches()(*int64) {
    return m.totalFetches
}
// GetUniqueClients gets the uniqueClients property value. The uniqueClients property
...
// SetFirstFetchedOn sets the firstFetchedOn property value. The firstFetchedOn property
...
// SetLastFetchedOn sets the lastFetchedOn property value. The lastFetchedOn property
func (m *VersionUsageMetrics) SetLastFetchedOn(value *int64)() {
    m.lastFetchedOn = value
}
// SetTotalFetches sets the totalFetches property value. The totalFetches property
func (m *VersionUsageMetrics) SetTotalFetches(value *int64)() {
    m.totalFetches = value
}
// SetUniqueClients sets the uniqueClients property value. The uniqueClients property
