...
public class EnvironmentVariables {
    ...
    // PEM-based TLS (used by KafkaAccess)
    public static final String KAFKASQL_SSL_TRUSTSTORE_CERTIFICATES = KAFKA_PREFIX + "SSL_TRUSTSTORE_CERTIFICATES";
    public static final String KAFKASQL_SSL_KEYSTORE_CERTIFICATE_CHAIN = KAFKA_PREFIX + "SSL_KEYSTORE_CERTIFICATE_CHAIN";
    public static final String KAFKASQL_SSL_KEYSTORE_KEY = KAFKA_PREFIX + "SSL_KEYSTORE_KEY";

    // SASL (generic, used by KafkaAccess SCRAM/JAAS)
    public static final String KAFKASQL_SASL_JAAS_CONFIG = KAFKA_PREFIX + "SASL_JAAS_CONFIG";
    public static final String KAFKASQL_SASL_MECHANISM = KAFKA_PREFIX + "SASL_MECHANISM";
    ...
    // Kubernetes auth related environment variables
    public static final String APICURIO_AUTHN_KUBERNETES_ENABLED = "APICURIO_AUTHN_KUBERNETES_ENABLED";
    public static final String APICURIO_AUTHN_KUBERNETES_API_AUDIENCES = "APICURIO_AUTHN_KUBERNETES_API_AUDIENCES";
    public static final String APICURIO_AUTHN_KUBERNETES_CACHE_EXPIRATION = "APICURIO_AUTHN_KUBERNETES_CACHE_EXPIRATION";
    public static final String APICURIO_AUTHN_MECHANISM_PRIORITY = "APICURIO_AUTHN_MECHANISM_PRIORITY";
    public static final String APICURIO_AUTH_ROLE_SOURCE_KUBERNETES_GROUP_MAPPING_ADMIN = "APICURIO_AUTH_ROLE_SOURCE_KUBERNETES_GROUP_MAPPING_ADMIN";
    public static final String APICURIO_AUTH_ROLE_SOURCE_KUBERNETES_GROUP_MAPPING_DEVELOPER = "APICURIO_AUTH_ROLE_SOURCE_KUBERNETES_GROUP_MAPPING_DEVELOPER";
    public static final String APICURIO_AUTH_ROLE_SOURCE_KUBERNETES_GROUP_MAPPING_READONLY = "APICURIO_AUTH_ROLE_SOURCE_KUBERNETES_GROUP_MAPPING_READONLY";
    ...
    public static final String QUARKUS_OTEL_TRACES_SAMPLER = "QUARKUS_OTEL_TRACES_SAMPLER";
    public static final String QUARKUS_OTEL_TRACES_SAMPLER_ARG = "QUARKUS_OTEL_TRACES_SAMPLER_ARG";

    // KubernetesOps related environment variables
    public static final String APICURIO_STORAGE_KIND = "APICURIO_STORAGE_KIND";
    public static final String APICURIO_POLLING_STORAGE_ID = "APICURIO_POLLING_STORAGE_ID";
    public static final String APICURIO_KUBERNETESOPS_NAMESPACE = "APICURIO_KUBERNETESOPS_NAMESPACE";
    public static final String APICURIO_POLLING_STORAGE_POLL_PERIOD = "APICURIO_POLLING_STORAGE_POLL_PERIOD";
    public static final String APICURIO_KUBERNETESOPS_LABEL_REGISTRY_ID = "APICURIO_KUBERNETESOPS_LABEL_REGISTRY_ID";
    ...
    public static final String QUARKUS_ELASTICSEARCH_HOSTS = "QUARKUS_ELASTICSEARCH_HOSTS";
    public static final String APICURIO_SEARCH_INDEX_ELASTICSEARCH_INDEX_NAME = "APICURIO_SEARCH_INDEX_ELASTICSEARCH_INDEX_NAME";
    public static final String QUARKUS_ELASTICSEARCH_USERNAME = "QUARKUS_ELASTICSEARCH_USERNAME";
    public static final String QUARKUS_ELASTICSEARCH_PASSWORD = "QUARKUS_ELASTICSEARCH_PASSWORD";
}
