...
* xref:registry-persistence-kafkasql-oauth[]
* xref:registry-persistence-kafkasql-access[]
...
include::partial$proc-persistence-kafkasql-oauth.adoc[leveloffset=+1]
include::partial$proc-persistence-kafkasql-access.adoc[leveloffset=+1]
