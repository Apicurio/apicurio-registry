...
* https://www.postgresql.org/docs/12/client-authentication.html[PostgreSQL documentation]

ifdef::apicurio-registry[]
* https://www.apicur.io/registry/docs/apicurio-registry/2.0.0.Final/getting-started/assembly-managing-registry-artifacts-api.html[Managing Apicurio Registry content using the REST API]
endif::[]
ifdef::service-registry[]
* link:{LinkManagingContentUsingRESTAPI}[{NameManagingContentUsingRESTAPI}]
endif::[]
