...
public interface Action<STATE extends State> {
    ...
    /**
     * Return an ordering in which this action should be initialized and executed, among other active actions.
     * Actions with the same ordering are executed in an unspecified order.
     */
