...
public enum DiffType {
    ...
    OBJECT_TYPE_PROPERTY_SCHEMAS_CHANGED(true),
    ...
    ARRAY_TYPE_ITEMS_SCHEMA_EXTENDED(true),
    ARRAY_TYPE_ITEMS_SCHEMA_NARROWED(false),
    ARRAY_TYPE_ITEMS_SCHEMA_CHANGED(false),
