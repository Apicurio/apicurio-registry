...
public enum DiffType {
    ...
    OBJECT_TYPE_REQUIRED_PROPERTIES_MEMBER_ADDED("A new required property was added", false),
    OBJECT_TYPE_REQUIRED_PROPERTIES_MEMBER_REMOVED("A required property was removed", true),
    ...
    OBJECT_TYPE_ADDITIONAL_PROPERTIES_FALSE_TO_TRUE("Additional properties are now allowed", true),
    OBJECT_TYPE_ADDITIONAL_PROPERTIES_TRUE_TO_FALSE("Additional properties are no longer allowed", false),
    ...
    NUMBER_TYPE_INTEGER_REQUIRED_FALSE_TO_TRUE("The value must now be an integer", false),
    NUMBER_TYPE_INTEGER_REQUIRED_TRUE_TO_FALSE("The value is no longer required to be an integer", true),
