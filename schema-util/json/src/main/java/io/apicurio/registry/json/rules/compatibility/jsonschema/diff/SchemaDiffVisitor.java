...
import io.apicurio.registry.json.rules.compatibility.jsonschema.wrapper.ConstSchemaWrapper;
import io.apicurio.registry.json.rules.compatibility.jsonschema.wrapper.EmptySchemaWrapper;
import io.apicurio.registry.json.rules.compatibility.jsonschema.wrapper.EnumSchemaWrapper;
import io.apicurio.registry.json.rules.compatibility.jsonschema.wrapper.FalseSchemaWrapper;
import io.apicurio.registry.json.rules.compatibility.jsonschema.wrapper.NotSchemaWrapper;
...
import io.apicurio.registry.json.rules.compatibility.jsonschema.wrapper.TrueSchemaWrapper;
...
public class SchemaDiffVisitor extends JsonSchemaWrapperVisitor {
    ...
    public void visitStringSchema(StringSchemaWrapper stringSchema) {
        ...
        if (!(subschema instanceof StringSchema)) {
            ctx.addDifference(DiffType.SUBSCHEMA_TYPE_CHANGED, subschema, stringSchema);
            return;
        }
    ...
    public void visitArraySchema(ArraySchemaWrapper arraySchema) {
        ...
        if (!(original instanceof ArraySchema)) {
            ctx.addDifference(DiffType.SUBSCHEMA_TYPE_CHANGED, original, arraySchema);
            return;
        }
    ...
    public void visitObjectSchema(ObjectSchemaWrapper schema) {
        ...
        if (!(original instanceof ObjectSchema)) {
            ctx.addDifference(DiffType.SUBSCHEMA_TYPE_CHANGED, original, schema);
            return;
        }
    ...
    public void visitBooleanSchema(BooleanSchemaWrapper schema) {
        ...
        if (!(subschema instanceof BooleanSchema)) {
            ctx.addDifference(DiffType.SUBSCHEMA_TYPE_CHANGED, subschema, schema);
            return;
        }
    ...
    public void visitConstSchema(ConstSchemaWrapper schema) {
        ...
        if (!(orig instanceof ConstSchema)) {
            ctx.addDifference(DiffType.SUBSCHEMA_TYPE_CHANGED, orig, schema);
            return;
        }
