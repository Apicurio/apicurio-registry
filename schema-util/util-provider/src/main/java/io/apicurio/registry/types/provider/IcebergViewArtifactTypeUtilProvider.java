...
/**
 * Artifact type utility provider for Apache Iceberg view metadata.
 *
 * Iceberg views are stored as JSON metadata documents that describe the view structure,
 * SQL representation, and schema information.
 *
 * @see <a href="https://iceberg.apache.org/spec/">Apache Iceberg Specification</a>
 */
public class IcebergViewArtifactTypeUtilProvider extends AbstractArtifactTypeUtilProvider {
    ...
    protected ContentAccepter createContentAccepter() {
        return new IcebergViewContentAccepter();
    }
    ...
    protected ContentValidator createContentValidator() {
        return new IcebergContentValidator(false);
    }

    @Override
    protected ContentExtractor createContentExtractor() {
        return new IcebergContentExtractor(false);
    }
    ...
    protected StructuredContentExtractor createStructuredContentExtractor() {
        return new IcebergStructuredContentExtractor(false);
    }
}
