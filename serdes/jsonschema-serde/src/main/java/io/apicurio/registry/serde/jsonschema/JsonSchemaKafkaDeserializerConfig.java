...
public class JsonSchemaKafkaDeserializerConfig extends BaseKafkaSerDeConfig {
    ...
    private static ConfigDef configDef() {
        ConfigDef configDef = new ConfigDef()
                .define(DESERIALIZER_SPECIFIC_KEY_RETURN_CLASS, Type.CLASS, null, Importance.MEDIUM,
                        SPECIFIC_RETURN_CLASS_DOC)
                .define(DESERIALIZER_SPECIFIC_VALUE_RETURN_CLASS, Type.CLASS, null, Importance.MEDIUM,
                        SPECIFIC_RETURN_CLASS_DOC)
                .define(VALIDATION_ENABLED, Type.BOOLEAN, VALIDATION_ENABLED_DEFAULT, Importance.MEDIUM,
                        "Whether to validate the data against the json schema");
        return configDef;
    }
