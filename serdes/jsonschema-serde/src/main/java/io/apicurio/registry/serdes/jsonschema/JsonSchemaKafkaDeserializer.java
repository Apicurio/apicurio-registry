 ...
 * @author Ales Justin
 */
public class JsonSchemaKafkaDeserializer<T> extends JsonSchemaKafkaSerDe<T, JsonSchemaKafkaDeserializer<T>> implements Deserializer<T> {
...
//                    id = toGlobalId(artifactId, version);
                    ...
                    schema = getSchemaResolver().resolveSchemaByGlobalId(globalId).getParsedSchema();
                }
