...
import io.apicurio.registry.serdes.SchemaLookupResult;
 ...
 * @author Ales Justin
 */
public class JsonSchemaKafkaSerializer<T> extends JsonSchemaKafkaSerDe<T, JsonSchemaKafkaSerializer<T>> implements Serializer<T> {
    ...
    public byte[] serialize(String topic, Headers headers, T data) {
        ...
        try {
            ...
            if (isValidationEnabled()) {
                ...
                SchemaLookupResult<SchemaValidator> schema = getSchemaResolver().resolveSchema(topic, headers, data);
