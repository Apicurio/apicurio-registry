...
public class AvroKafkaSerdeConfig extends BaseKafkaSerDeConfig {
    ...
    private static ConfigDef configDef() {
        ConfigDef configDef = new ConfigDef()
                .define(AVRO_ENCODING, Type.STRING, AvroEncoding.BINARY.name(), Importance.MEDIUM,
                        "TODO docs")
                .define(AVRO_DATUM_PROVIDER, Type.CLASS, AVRO_DATUM_PROVIDER_DEFAULT, Importance.MEDIUM,
                        "TODO docs")
                .define(USE_SPECIFIC_AVRO_READER, Type.BOOLEAN, USE_SPECIFIC_AVRO_READER_DEFAULT,
                        Importance.MEDIUM, "TODO docs");
        return configDef;
    }
