...
package io.apicurio.registry.serdes.strategy;
...
public interface ArtifactIdStrategy<T> {
    ...
    //TODO adapt this to work with groupId
    //maybe have a static groupId by config property and to allow for dynamic resolving the groupId via this strategy?
