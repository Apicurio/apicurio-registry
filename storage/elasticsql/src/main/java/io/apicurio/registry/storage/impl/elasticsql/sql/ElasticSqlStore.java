package io.apicurio.registry.storage.impl.elasticsql.sql;
...
/**
 * * The SQL store used by the ElasticSQL registry artifactStore implementation.  This is ultimately where each
 *  * application replica stores its data after injecting it to ElasticSearch.  Often this is a
 ...
 *  *
 *  * @author eric.wittmann@gmail.com, vvilerio
 */
@ApplicationScoped
@Named("ElasticSqlStore")
@Logged
public class ElasticSqlStore extends AbstractSqlRegistryStorage {
