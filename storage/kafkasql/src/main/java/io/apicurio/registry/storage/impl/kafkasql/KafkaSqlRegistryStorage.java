...
import io.apicurio.registry.storage.impl.sql.*;
...
public class KafkaSqlRegistryStorage extends RegistryStorageDecoratorReadOnlyBase {
    ...
    @Override
    @Transactional
    public void importData(EntityInputStream entities, boolean preserveGlobalId, boolean preserveContentId) throws ReadOnlyStorageException {
