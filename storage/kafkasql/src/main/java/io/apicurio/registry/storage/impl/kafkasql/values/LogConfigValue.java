...
public class LogConfigValue extends AbstractMessageValue {
     ...
     * @param config
     */
    public static final LogConfigValue create(ActionType action, LogConfigurationDto config) {
        LogConfigValue value = new LogConfigValue();
     ...
     */
    public void setConfig(LogConfigurationDto config) {
        this.config = config;
    }
