...
import io.apicurio.registry.storage.impl.ksql.serde.KafkaSqlKeyDeserializer;
import io.apicurio.registry.storage.impl.ksql.serde.KafkaSqlKeySerializer;
import io.apicurio.registry.storage.impl.ksql.serde.KafkaSqlPartitioner;
import io.apicurio.registry.storage.impl.ksql.serde.KafkaSqlValueDeserializer;
import io.apicurio.registry.storage.impl.ksql.serde.KafkaSqlValueSerializer;
import io.apicurio.registry.storage.impl.ksql.sql.KafkaSqlSink;
import io.apicurio.registry.storage.impl.ksql.sql.KafkaSqlStore;
...
public class KafkaSqlRegistryStorage extends AbstractRegistryStorage implements MessageSender {
    ...
    /**
     * @see io.apicurio.registry.storage.impl.ksql.MessageSender#send(io.apicurio.registry.storage.impl.ksql.keys.MessageKey, io.apicurio.registry.storage.impl.ksql.values.MessageValue)
     */
    @Override
