...
import io.apicurio.registry.storage.util.H2DatabaseResourceManager;
 ...
 */
@QuarkusTest
@QuarkusTestResource(H2DatabaseResourceManager.class)
class SqlRegistryStorageTest {
    ...
    @Inject
    PanacheRegistryStorage storage;
    ...
    void testCreateArtifact() throws Exception {
        ...
        Assertions.assertEquals(2, versions.iterator().next());
    }
