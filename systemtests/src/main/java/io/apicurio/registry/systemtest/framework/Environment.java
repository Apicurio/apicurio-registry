...
public final class Environment {
    ...
    public static final String SSO_CATALOG_NAMESPACE_ENV_VAR = "SSO_CATALOG_NAMESPACE";
    ...
    public static final String KAFKA_CATALOG_NAMESPACE = getOrDefault(
            KAFKA_CATALOG_NAMESPACE_ENV_VAR,
    ...
    public static final String REGISTRY_CATALOG_NAMESPACE = getOrDefault(
            REGISTRY_CATALOG_NAMESPACE_ENV_VAR,
            REGISTRY_CATALOG_NAMESPACE_DEFAULT
    );
