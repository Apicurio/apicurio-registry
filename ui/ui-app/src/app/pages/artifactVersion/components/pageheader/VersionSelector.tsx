        ...
        >
            ...
            <div className="version-list">
                <Link key="latest"
                    ...
                    to={appNav.createLink(`/explore/${encodeURIComponent(props.groupId)}/${encodeURIComponent(props.artifactId)}/versions/latest`)}
                ...
                </Link>
                {
                    props.versions.map((v, idx) =>
                        <Link key={v.version}
                            ...
                            to={appNav.createLink(`/explore/${encodeURIComponent(props.groupId)}/${encodeURIComponent(props.artifactId)}/versions/${v.version}`)}
