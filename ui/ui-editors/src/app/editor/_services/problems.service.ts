...
var PROBLEM_EXPLANATIONS = {
    ...
    "PAR-007"  : `All Path Parameters must have a name that maps to one of the dynamic elements of the path's template.  For example, if the path template is "/items/{itemId}/widgets/{widgetId}" then the only valid values for Path Parameter names are "itemId" and "widgetId".`,
