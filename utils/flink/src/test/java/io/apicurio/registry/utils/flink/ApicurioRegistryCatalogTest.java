...
public class ApicurioRegistryCatalogTest {

    @Test
    public void testFlinkCatalogOperations() throws Exception {
        ...
        // Register the Apicurio Registry Catalog
        tableEnv.registerCatalog("apicurio", new ApicurioRegistryCatalog("apicurio", "http://localhost:8080/apis/registry/v3"));

        // Use the Apicurio catalog
        tableEnv.useCatalog("apicurio");

        // Create source table
        tableEnv.executeSql("CREATE TABLE source_orders (" +
                "order_id INT, " +
                "product STRING, " +
                "quantity INT, " +
                "price DECIMAL(10,2)" +
        ...
        // Create a view for aggregated data
        tableEnv.executeSql("CREATE VIEW product_totals AS " +
                "SELECT product, " +
        ...
        // Let it run for a few seconds to generate some data
        Thread.sleep(5000);
        ...
        // Clean up
        tableEnv.executeSql("DROP VIEW product_totals");
        tableEnv.executeSql("DROP TABLE order_summary");
        tableEnv.executeSql("DROP TABLE source_orders");
    }

    private static class MyCatalog implements Catalog {
